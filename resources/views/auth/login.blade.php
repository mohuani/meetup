...
<div class="am-g">
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        {{--<div class="am-btn-group">--}}
            ...
            {{--<a href="{{ route('auth/github') }}" class="am-btn am-btn-default am-btn-sm"><i class="am-icon-github am-icon-sm"></i> Github</a>--}}
            {{--<a href="/auth/github" class="am-btn am-btn-default am-btn-sm"><i class="am-icon-github am-icon-sm"></i> Github</a>--}}
        {{--</div>--}}
        {{--<br>--}}
        {{--<br>--}}
