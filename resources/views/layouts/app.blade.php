...
<head lang="en">
    ...
    <link rel="stylesheet" href="{{URL::asset('assets/vendor/amazeui/css/amazeui.min.css')}}"/>
...
<script src="{{URL::asset('assets/vendor/amazeui/js/amazeui.ie8polyfill.min.js')}}"></script>
<![endif]-->
...
<script src="{{URL::asset('assets/vendor/amazeui/js/amazeui.min.js')}}"></script>
<script src="{{URL::asset('assets/js/laravel.js')}}"></script>
