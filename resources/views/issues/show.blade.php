...
@section('stylesheets')
    <link rel="stylesheet" href="{{URL::asset('assets/vendor/atwho/jquery.atwho.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('assets/vendor/highlight/default.min.css')}}">
    <style>
        .am-comment-bd h2 {
            margin-top: 0;
...
@section('scripts')
    <script src="{{URL::asset('assets/vendor/highlight/highlight.min.js')}}"></script>
    <script src="{{URL::asset('assets/vendor/atwho/jquery.caret.min.js')}}"></script>
    <script src="{{URL::asset('assets/vendor/atwho/jquery.atwho.min.js')}}"></script>
    <script src="{{URL::asset('assets/vendor/jquery.hotkeys/jquery.hotkeys.js')}}"></script>
    <script src="{{URL::asset('assets/js/show.js')}}"></script>
@endsection